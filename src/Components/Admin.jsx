...
function Admin() {
  ...
  const handleSelectChange = (event) => {
    ...
    // Show additional input only if option 2 or 3 is selected
    setAdditionalInputVisible(selectedValue === '2' || selectedValue === '3');
  };
    ...
    <div className='mt-[100px]'>
      <form className="max-w-md mx-auto">
        ...
        {additionalInputVisible && (
          <div className="mt-4">
            <label className="block text-sm text-gray-700 dark:text-white">Additional Input:</label>
            <input
              type="text"
              className="mt-1 p-2.5 w-full text-sm dark:text-white dark:bg-gray-700 border border-gray-300 rounded-md"
              placeholder="Type 'yes', 'no', or 'never mind'"
            />
          </div>
        )}
